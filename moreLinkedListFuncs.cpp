...
void addIntToEndOfList(LinkedList *list, int value) {
  ...
  p = new Node {value, nullptr}; // THIS IS PLACE-HOLDER LINE OF CODE.  DELETE IT AND REPLACE IT.
